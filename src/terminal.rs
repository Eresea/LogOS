...
impl Terminal {
    pub const fn new() -> Self {
        Self {
            columns: crate::terminal_abi::DEFAULT_COLUMNS,
            rows: crate::terminal_abi::DEFAULT_ROWS,
            cursor_column: 0,
            cursor_row: 0,
            saved_column: 0,
            saved_row: 0,
    ...
    pub fn reset(&mut self) {
        self.columns = crate::terminal_abi::DEFAULT_COLUMNS;
        self.rows = crate::terminal_abi::DEFAULT_ROWS;
