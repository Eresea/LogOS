...
| 4 | [Persistence v1](PERSISTENCE.md) | **Next** | Capability-scoped state survives interrupted writes and resets |
| 5 | [Network v1](NETWORK.md) | Planned | Capability-controlled networking completes validated TLS |
