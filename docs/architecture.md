...
| Atrium service | `services/images/src/atrium` + `logos-atrium::Atrium` | owns Boot/Locked/Home routing, one volatile workspace, bounded launcher/window slots, keyboard focus/movement/close policy, and app surface orchestration; it never receives the framebuffer |
