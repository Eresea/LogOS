...
After ABI v5 stabilization, one bounded Network-client migration, and one bounded Remote
migration, ABI v5 structure is frozen. Further work returns to capability development: Remote
